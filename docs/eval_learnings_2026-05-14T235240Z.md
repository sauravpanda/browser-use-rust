...
## 2026-05-15T15:08:45Z Update: Telegraph Brexit Targeted Eval Launched

Targeted run:

- Run `kh7cdcztq0n8tsg9s7813mxdf986s6r6`, workflow `25925264618`,
  commit `dcf02145f53419e47b0d34e37c22d69772c41936`.
- Dataset range: `start_index=119`, `end_index=120`, task `1764`.
- User message:
  `bu-rust telegraph-brexit-search onsite targeted no-thinking gpt-o4-mini`.
...
- Probe run `kh77n047nz4pethd824ameqtd186sarz` was accidentally created
...
## 2026-05-15T15:15:18Z Update: Telegraph Brexit Refined Eval Launched
...
- Dataset range: `start_index=119`, `end_index=120`, task `1764`.
- User message:
  `bu-rust telegraph-brexit-search validation-skip targeted no-thinking gpt-o4-mini`.
...
## 2026-05-15T15:25:09Z Update: GameSpot Targeted Eval Launched

Targeted run:

- Run `kh79z5rw45bevmqy0z1658qpfd86rtpe`, workflow `25926046199`,
  commit `fe1c10bb870ab34d979eedd64e1cbe23310381d2`.
- Dataset range: `start_index=95`, `end_index=96`, task `614`.
- User message:
  `bu-rust gamespot-action-review targeted no-thinking gpt-o4-mini`.
...
## 2026-05-15T16:23:10Z Update: Daily Mail Targeted Eval Launched

Targeted run:

- Run `kh73kzpxzc5khp4g7ppkqrteah86r2md`, workflow `25928801862`,
  commit `bf4532af2e82af2483b988c3a2a43168c57c28a9`.
- Dataset range: `start_index=187`, `end_index=188`, task `2459`.
- User message:
  `bu-rust dailymail-top-breaking targeted no-thinking gpt-o4-mini`.
...
## 2026-05-15T16:54:52Z Update: Oxford Targeted Eval Launched

Targeted run:

- Run `kh7f0rpe7ra5e7hnae7zeq54q986rnf5`, workflow `25930232177`,
  commit `fe37602e6df9c0ac1c7a8b5357081093356df057`.
- Dataset range: `start_index=47`, `end_index=48`, task `2625`.
- User message: `bu-rust oxford-integrity targeted no-thinking gpt-o4-mini`.
