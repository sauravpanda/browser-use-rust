...
class ChatAnthropic(BaseChatModel):
    ...
    async def ainvoke(
        ...
        *,
        ...
        #
        # v0.11.20 tried adding a 3rd breakpoint on the AGENT_HISTORY
        # block (Anthropic supports up to 4). Reverted in v0.11.21:
        # cost-per-M was flat (+1%) and steps/tokens/time/errors all
        # rose materially (+11/+14/+27/+33%). Same pattern as v0.11.14
        # docstring trim and v0.11.19 memory-cap: any change visible
        # to the LLM, even purportedly "invisible" architectural ones,
        # can disturb its behavior and cause compensation overhead.
        # Cache architecture optimization is therefore not a free
        # action on this substrate.
        #
